...
> **当前版本**：2.3.0（更新说明见 [`docs/CHANGELOG.md`](docs/CHANGELOG.md)）
...
| 此刻 | 文字+图片+标签+**心情**记录、时间线/日历视图、搜索、**心情/标签筛选**、编辑/删除（**3 秒撤销**）、**记录模板一键填充** |
| 我的 | 用户资料/头像、主题/字体/隐私设置、**数据看板（统计+里程碑）**、缓存清理、个性化管理（标签/心情/模板）、导出/导入与备份、重置 |
